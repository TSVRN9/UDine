...
**Terrace intermittency mechanism + wider gap-list re-test (2026-09-14, follow-up to PR #481, branch
`docs/retail-nutrition-gap-research`, still open as of this pass) -- this repo's `main` doesn't yet
carry PR #481's "Retail nutrition gap: enumeration and path forward" writeup, so this note restates
what it needs inline rather than cross-referencing a subsection that isn't in this checkout.** PR
