...
| F5 -- Direct lookup settled: found N new foods (new) | `SearchLookupFound.dc.html` | 390×844 | `components/PlateSheet.tsx` |
| F5 -- Direct lookup settled: no new foods (new) | `SearchLookupNone.dc.html` | 390×844 | `components/PlateSheet.tsx` |
| F5 -- Direct lookup offline (new) | `SearchLookupOffline.dc.html` | 390×844 | `components/PlateSheet.tsx` |
...
| H2H -- Round complete: after the 5th pick, no Another | `CompareToastRoundDone.dc.html` | 390×844 | `components/Toast.tsx` (no action), `app/halls/[slug].tsx`, `panes/YouPane.tsx` |
...
| H2H -- You pane: today's allowance used, no Rate more | `YouTopFoodsAllowanceUsed.dc.html` | 390×844 | `panes/YouPane.tsx`, `components/ui/SectionHeader.tsx` |
