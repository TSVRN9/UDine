...
#   You pane compare entry points (panes/YouPane.tsx, __DEV__ only, route `index` then swipe to the You
#   pane): NAME=compare-seed logs French Toast / Belgian Waffle / Scrambled Eggs and seeds them
