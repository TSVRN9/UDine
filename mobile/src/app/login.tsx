...
const styles = StyleSheet.create({
  ...
  top: { paddingTop: fs(110), paddingHorizontal: spacing(8), gap: spacing(4) },
  ...
  bottom: { paddingHorizontal: spacing(6), paddingBottom: fs(44), gap: spacing(3) },
  googleButton: {
    flexDirection: "row",
    alignItems: "center",
  ...
  googleGlyphCircle: { width: fs(22), height: fs(22), borderRadius: radii.pill, alignItems: "center", justifyContent: "center", backgroundColor: "#4285F4" },
