...
const styles = StyleSheet.create({
  ...
  chipNumber: { fontFamily: fonts.mono, fontSize: fs(13) },
  chipNumberSelected: { color: colors.paper50, fontWeight: "600" },
  chipNumberOutlined: { color: colors.maroon900, fontWeight: "600" },
  chipNumberFuture: { color: withOpacity(colors.ink900, 35), fontWeight: "400" },
