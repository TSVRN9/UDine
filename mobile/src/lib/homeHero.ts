...
/** Grab 'N Go screen header subtitle ("open now · until 7:00 PM") — same status shape as
 * formatLocationChip but lowercase sentence-style text for a header subtitle line, not a chip. */
