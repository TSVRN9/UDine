...
/** SQLite-backed RankingStorage — device-only, always, see CLAUDE.md data residency table. Reuses the existing preferences_kv table (one small JSON blob) rather than a new table. */
export class SqliteRankingStorage implements RankingStorage {
